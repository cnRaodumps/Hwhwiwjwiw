...
from anshi.config import REGISTER_BONUS, OWNER_ID, TAX_RATE, CLAIM_BONUS, MARRIED_TAX_RATE, SHOP_ITEMS, MIN_CLAIM_MEMBERS
from anshi.utils import ensure_user_exists, get_mention, format_money, resolve_target, log_to_channel, stylize_text, track_group
from anshi.database import users_collection, groups_collection
from anshi.plugins.chatbot import ask_mistral_raw
...
async def register(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat.type != ChatType.PRIVATE:
        ...
        return await update.message.reply_text(
            "❌ <b>anshi!</b> You cannot register in a group!\n"
...
async def claim(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat.type == ChatType.PRIVATE:
        return await update.message.reply_text("⚠️ <b>anshi!</b> This command is for Group Bonuses only.", parse_mode=ParseMode.HTML)
