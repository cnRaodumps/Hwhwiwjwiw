...
from anshi.database import riddles_collection, users_collection
from anshi.utils import format_money, ensure_user_exists, get_mention
from anshi.config import RIDDLE_REWARD
