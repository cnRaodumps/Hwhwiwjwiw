...
from anshi.config import OWNER_ID, UPSTREAM_REPO, GIT_TOKEN
from anshi.utils import SUDO_USERS, get_mention, resolve_target, format_money, reload_sudoers
...
async def confirm_handler(update, context):
    ...
    await q.answer()
    if q.from_user.id not in SUDO_USERS: return await q.message.edit_text("❌ <b>anshi!</b> Not for you.", parse_mode=ParseMode.HTML)
